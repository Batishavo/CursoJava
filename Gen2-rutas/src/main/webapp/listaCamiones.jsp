...
<%@page import="com.romero.app.rutas.models.*" %>
                        ...
                        <tbody>
                            <% for(Camion c: camiones){ %>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<%=request.getContextPath()%>/camiones/detalle?id=<%=c.getId()%>"
                                            class="btn btn-success">Detalle</a>
                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/camiones/editar?id=<%=c.getId()%>"
                                            class="btn btn-primary">Editar</a>
                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/camiones/eliminar?id=<%=c.getId()%>"
