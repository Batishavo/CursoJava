                        ...
                        <tbody>
                            <% for(Chofer c: choferes){ %>
                                <tr>
                                    ...
                                    <td> <%=c.getTelefono()%> </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/choferes/detalle?id=<%=c.getId()%>"
                                         class="btn btn-success">Detalle</a>
                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/choferes/editar?id=<%=c.getId()%>"
                                            class="btn btn-primary">Editar</a>
                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/choferes/eliminar?id=<%=c.getId()%>"
